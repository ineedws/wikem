...
if (!defined('USERID')){	define('USERID','45');} // find it at Special:Preferences
if (!defined('USERNAME')){	define('USERNAME','robot2');}
if (!defined('PASSWORD')){	define('PASSWORD','wikem-vona');} // password in plain text. No md5 or anything.
