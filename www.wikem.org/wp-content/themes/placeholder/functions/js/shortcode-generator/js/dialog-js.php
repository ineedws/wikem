...
var wooDialogHelper = {
    ...
    makeShortcode: function () {
        ...
        return "[" + wooShortcodeMeta.shortcode + f + "]" + (c ? c + "[/" + wooShortcodeMeta.shortcode + "] " : " ")
    },
    ...
    previewAction: function (a) {
        ...
        jQuery("#woo-preview-iframe").attr("src", shortcode_generator_path + "preview-shortcode-external.php?shortcode=" + encodeURIComponent(this.makeShortcode()))
    },
