...
<html xmlns="<?php $this->text('xhtmldefaultnamespace') ?>" <?php 
	...
	<head>
		...
		<link rel="apple-touch-icon" href="/common/images/WikEM-Logo.png" />
...
<?php		}
		...
		if(!empty($this->data['nav_urls']['print']['href'])) { ?>
				...
				?>"<?php echo $skin->tooltipAndAccesskeyAttribs('t-print') ?>><?php $this->msg('printableversion') ?></a></li>
<?php
		}

		if(!empty($this->data['nav_urls']['permalink']['href'])) { ?>
				<li id="t-permalink"><a href="<?php echo htmlspecialchars($this->data['nav_urls']['permalink']['href'])
				?>"<?php echo $skin->tooltipAndAccesskeyAttribs('t-permalink') ?>><?php $this->msg('permalink') ?></a></li>
<?php
...
<div id="headerbar">
	<div id="headerbar-title">
		<img id="logo-icon" src=" /common/images/WikEM-Logo.png" alt="<?php $this->msg('sitetitle') ?>" />
